...
{
    /// <inheritdoc />
    public class UnstableCreateEvaluationRuleRequestJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Langfuse.UnstableCreateEvaluationRuleRequest>
    {
        /// <inheritdoc />
        public override global::Langfuse.UnstableCreateEvaluationRuleRequest Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Langfuse.UnstableCreateLlmAsJudgeEvaluationRuleRequest), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Langfuse.UnstableCreateLlmAsJudgeEvaluationRuleRequest> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Langfuse.UnstableCreateLlmAsJudgeEvaluationRuleRequest).Name}");
                        unstableCreateLlmAsJudgeEvaluationRuleRequest = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        unstableCreateCodeEvaluationRuleRequest = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
        ...
        public override void Write(
            ...
            global::Langfuse.UnstableCreateEvaluationRuleRequest value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsUnstableCreateLlmAsJudgeEvaluationRuleRequest)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Langfuse.UnstableCreateLlmAsJudgeEvaluationRuleRequest), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Langfuse.UnstableCreateLlmAsJudgeEvaluationRuleRequest?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Langfuse.UnstableCreateLlmAsJudgeEvaluationRuleRequest).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.UnstableCreateLlmAsJudgeEvaluationRuleRequest!, typeInfo);
            }
            else if (value.IsUnstableCreateCodeEvaluationRuleRequest)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Langfuse.UnstableCreateCodeEvaluationRuleRequest), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Langfuse.UnstableCreateCodeEvaluationRuleRequest?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Langfuse.UnstableCreateCodeEvaluationRuleRequest).Name}");
