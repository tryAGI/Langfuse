...
namespace Langfuse
{
    public partial class EvaluatorsClient
    {
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement s_EvaluatorsListVersionsSecurityRequirement0 =
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement[] s_EvaluatorsListVersionsSecurityRequirements =
            new global::Langfuse.EndPointSecurityRequirement[]
            {                s_EvaluatorsListVersionsSecurityRequirement0,
            };
        partial void PrepareEvaluatorsListVersionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string evaluatorId,
            ref int? limit,
            ref string? cursor);
        partial void PrepareEvaluatorsListVersionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string evaluatorId,
            int? limit,
            string? cursor);
        partial void ProcessEvaluatorsListVersionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEvaluatorsListVersionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.EvaluatorVersionsPage> EvaluatorsListVersionsAsync(
            string evaluatorId,
            int? limit = default,
        ...
        {
            var __response = await EvaluatorsListVersionsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Langfuse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Langfuse.AutoSDKHttpResponse<global::Langfuse.EvaluatorVersionsPage>> EvaluatorsListVersionsAsResponseAsync(
            string evaluatorId,
            int? limit = default,
            string? cursor = default,
            global::Langfuse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEvaluatorsListVersionsArguments(
            ...
            var __authorizations = global::Langfuse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EvaluatorsListVersionsSecurityRequirements,
                operationName: "EvaluatorsListVersionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEvaluatorsListVersionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Langfuse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EvaluatorsListVersions",
                                methodName: "EvaluatorsListVersionsAsync",
                                pathTemplate: "$\"/api/public/v2/evaluators/{evaluatorId}/versions\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEvaluatorsListVersionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEvaluatorsListVersionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Langfuse.EvaluatorVersionsPage.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Langfuse.AutoSDKHttpResponse<global::Langfuse.EvaluatorVersionsPage>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Langfuse.EvaluatorVersionsPage.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
