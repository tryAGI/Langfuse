...
namespace Langfuse
{
    public partial class UnstableDashboardsClient
    {
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement s_UnstableDashboardsListSecurityRequirement0 =
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement[] s_UnstableDashboardsListSecurityRequirements =
            new global::Langfuse.EndPointSecurityRequirement[]
            {                s_UnstableDashboardsListSecurityRequirement0,
            };
        partial void PrepareUnstableDashboardsListArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? page,
            ref int? limit);
        partial void PrepareUnstableDashboardsListRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? page,
            int? limit);
        partial void ProcessUnstableDashboardsListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUnstableDashboardsListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List dashboards in the project, ordered by most recently updated<br/>
        /// first.
        /// </summary>
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.UnstableDashboardList> UnstableDashboardsListAsync(
            int? page = default,
            int? limit = default,
            global::Langfuse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await UnstableDashboardsListAsResponseAsync(
                page: page,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Langfuse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Langfuse.AutoSDKHttpResponse<global::Langfuse.UnstableDashboardList>> UnstableDashboardsListAsResponseAsync(
            int? page = default,
            int? limit = default,
            global::Langfuse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUnstableDashboardsListArguments(
            ...
            var __authorizations = global::Langfuse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnstableDashboardsListSecurityRequirements,
                operationName: "UnstableDashboardsListAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUnstableDashboardsListRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Langfuse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UnstableDashboardsList",
                                methodName: "UnstableDashboardsListAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUnstableDashboardsListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnstableDashboardsListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Langfuse.UnstableDashboardList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Langfuse.AutoSDKHttpResponse<global::Langfuse.UnstableDashboardList>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Langfuse.UnstableDashboardList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
