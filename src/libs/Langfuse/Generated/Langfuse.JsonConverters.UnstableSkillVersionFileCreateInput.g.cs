...
{
    /// <inheritdoc />
    public class UnstableSkillVersionFileCreateInputJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Langfuse.UnstableSkillVersionFileCreateInput>
    {
        /// <inheritdoc />
        public override global::Langfuse.UnstableSkillVersionFileCreateInput Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("sha256Hash")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            if (__score0 > __bestScore) { __bestScore = __score0; __bestIndex = 0; }
            if (__score1 > __bestScore) { __bestScore = __score1; __bestIndex = 1; }

            global::Langfuse.UnstableSkillVersionFileInput? unstableSkillVersionFileInput = default;
            global::Langfuse.UnstableSkillVersionFileReference? unstableSkillVersionFileReference = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        unstableSkillVersionFileInput = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        unstableSkillVersionFileReference = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (unstableSkillVersionFileInput == null && unstableSkillVersionFileReference == null)
            {
                try
                {
            ...
            var __value = new global::Langfuse.UnstableSkillVersionFileCreateInput(
        ...
        public override void Write(
            ...
            global::Langfuse.UnstableSkillVersionFileCreateInput value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsUnstableSkillVersionFileInput)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Langfuse.UnstableSkillVersionFileInput), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Langfuse.UnstableSkillVersionFileInput?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Langfuse.UnstableSkillVersionFileInput).Name}");
