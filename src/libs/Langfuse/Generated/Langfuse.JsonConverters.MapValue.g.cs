...
{
    /// <inheritdoc />
    public class MapValueJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Langfuse.MapValue>
    {
        /// <inheritdoc />
        public override global::Langfuse.MapValue Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        floatNumber = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (@string == null && integer == null && floatNumber == null && boolean == null && array == null)
            {
                try
                {
            ...
            var __value = new global::Langfuse.MapValue(
                @string,
        ...
        public override void Write(
            ...
            global::Langfuse.MapValue value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
