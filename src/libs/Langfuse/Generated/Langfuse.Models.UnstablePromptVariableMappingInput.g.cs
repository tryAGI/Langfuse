...
{
    /// <summary>
    /// Connects one prompt variable to the available evaluation data.<br/>
    ...
    /// - `missing_variable_mapping`: one or more LLM-as-judge prompt variables are not mapped yet<br/>
    /// - `duplicate_variable_mapping`: the same prompt variable appears more than once<br/>
    ...
    public sealed partial class UnstablePromptVariableMappingInput
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnstablePromptVariableMappingInput" /> class.
        /// </summary>
        /// <param name="variable">
        /// Prompt variable name without braces.<br/>
        /// Example: for the prompt `Judge {{input}} against {{output}}`, use `input` and `output`.
...
#endif
        public UnstablePromptVariableMappingInput(
            string variable,
