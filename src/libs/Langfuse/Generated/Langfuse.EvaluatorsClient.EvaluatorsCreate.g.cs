...
namespace Langfuse
{
    public partial class EvaluatorsClient
    {
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement s_EvaluatorsCreateSecurityRequirement0 =
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement[] s_EvaluatorsCreateSecurityRequirements =
            new global::Langfuse.EndPointSecurityRequirement[]
            {                s_EvaluatorsCreateSecurityRequirement0,
            };
        partial void PrepareEvaluatorsCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Langfuse.CreateEvaluatorRequest request);
        partial void PrepareEvaluatorsCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Langfuse.CreateEvaluatorRequest request);
        partial void ProcessEvaluatorsCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEvaluatorsCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.Evaluator> EvaluatorsCreateAsync(

            global::Langfuse.CreateEvaluatorRequest request,
            global::Langfuse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await EvaluatorsCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Langfuse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Langfuse.AutoSDKHttpResponse<global::Langfuse.Evaluator>> EvaluatorsCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEvaluatorsCreateArguments(
            ...
            var __authorizations = global::Langfuse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EvaluatorsCreateSecurityRequirements,
                operationName: "EvaluatorsCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEvaluatorsCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Langfuse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EvaluatorsCreate",
                                methodName: "EvaluatorsCreateAsync",
                                pathTemplate: "\"/api/public/v2/evaluators\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEvaluatorsCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEvaluatorsCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.Evaluator> EvaluatorsCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Langfuse.CreateEvaluatorRequest
            {
            };

            return await EvaluatorsCreateAsync(
                request: __request,
                requestOptions: requestOptions,
