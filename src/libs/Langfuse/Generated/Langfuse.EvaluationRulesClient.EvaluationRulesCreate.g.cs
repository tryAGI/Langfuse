...
namespace Langfuse
{
    public partial class EvaluationRulesClient
    {
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement s_EvaluationRulesCreateSecurityRequirement0 =
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement[] s_EvaluationRulesCreateSecurityRequirements =
            new global::Langfuse.EndPointSecurityRequirement[]
            {                s_EvaluationRulesCreateSecurityRequirement0,
            };
        partial void PrepareEvaluationRulesCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Langfuse.CreateEvaluationRuleRequest request);
        partial void PrepareEvaluationRulesCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Langfuse.CreateEvaluationRuleRequest request);
        partial void ProcessEvaluationRulesCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEvaluationRulesCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.EvaluationRule> EvaluationRulesCreateAsync(

            global::Langfuse.CreateEvaluationRuleRequest request,
            global::Langfuse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await EvaluationRulesCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Langfuse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Langfuse.AutoSDKHttpResponse<global::Langfuse.EvaluationRule>> EvaluationRulesCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEvaluationRulesCreateArguments(
            ...
            var __authorizations = global::Langfuse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EvaluationRulesCreateSecurityRequirements,
                operationName: "EvaluationRulesCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEvaluationRulesCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Langfuse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EvaluationRulesCreate",
                                methodName: "EvaluationRulesCreateAsync",
                                pathTemplate: "\"/api/public/v2/evaluation-rules\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEvaluationRulesCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEvaluationRulesCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.EvaluationRule> EvaluationRulesCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Langfuse.CreateEvaluationRuleRequest
            {
                Name = name,
                Enabled = enabled,
                Sampling = sampling,
            ...
            return await EvaluationRulesCreateAsync(
                request: __request,
                requestOptions: requestOptions,
