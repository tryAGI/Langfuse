...
namespace Langfuse
{
    public partial class UnstableSkillsClient
    {
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement s_UnstableSkillsGetSecurityRequirement0 =
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement[] s_UnstableSkillsGetSecurityRequirements =
            new global::Langfuse.EndPointSecurityRequirement[]
            {                s_UnstableSkillsGetSecurityRequirement0,
            };
        partial void PrepareUnstableSkillsGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string skillName,
            ref int? version,
            ref string? label);
        partial void PrepareUnstableSkillsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string skillName,
            int? version,
            string? label);
        partial void ProcessUnstableSkillsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUnstableSkillsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.UnstableSkillVersion> UnstableSkillsGetAsync(
            string skillName,
            int? version = default,
        ...
        {
            var __response = await UnstableSkillsGetAsResponseAsync(
                skillName: skillName,
                version: version,
                label: label,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Langfuse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Langfuse.AutoSDKHttpResponse<global::Langfuse.UnstableSkillVersion>> UnstableSkillsGetAsResponseAsync(
            string skillName,
            int? version = default,
            string? label = default,
            global::Langfuse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUnstableSkillsGetArguments(
            ...
            var __authorizations = global::Langfuse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnstableSkillsGetSecurityRequirements,
                operationName: "UnstableSkillsGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUnstableSkillsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Langfuse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UnstableSkillsGet",
                                methodName: "UnstableSkillsGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUnstableSkillsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnstableSkillsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
