...
namespace Langfuse
{
    public partial class UnstableEvaluationRulesClient
    {
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement s_UnstableEvaluationRulesGetSecurityRequirement0 =
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement[] s_UnstableEvaluationRulesGetSecurityRequirements =
            new global::Langfuse.EndPointSecurityRequirement[]
            {                s_UnstableEvaluationRulesGetSecurityRequirement0,
            };
        partial void PrepareUnstableEvaluationRulesGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string evaluationRuleId);
        partial void PrepareUnstableEvaluationRulesGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string evaluationRuleId);
        partial void ProcessUnstableEvaluationRulesGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUnstableEvaluationRulesGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await UnstableEvaluationRulesGetAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUnstableEvaluationRulesGetArguments(
            ...
            var __authorizations = global::Langfuse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnstableEvaluationRulesGetSecurityRequirements,
                operationName: "UnstableEvaluationRulesGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUnstableEvaluationRulesGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Langfuse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UnstableEvaluationRulesGet",
                                methodName: "UnstableEvaluationRulesGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUnstableEvaluationRulesGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnstableEvaluationRulesGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
