...
namespace Langfuse
{
    public partial class EvaluatorsClient
    {
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement s_EvaluatorsUpdateSecurityRequirement0 =
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement[] s_EvaluatorsUpdateSecurityRequirements =
            new global::Langfuse.EndPointSecurityRequirement[]
            {                s_EvaluatorsUpdateSecurityRequirement0,
            };
        partial void PrepareEvaluatorsUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string evaluatorId,
            global::Langfuse.UpdateEvaluatorRequest request);
        partial void PrepareEvaluatorsUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string evaluatorId,
            global::Langfuse.UpdateEvaluatorRequest request);
        partial void ProcessEvaluatorsUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEvaluatorsUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.Evaluator> EvaluatorsUpdateAsync(
            string evaluatorId,
        ...
        {
            var __response = await EvaluatorsUpdateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Langfuse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Langfuse.AutoSDKHttpResponse<global::Langfuse.Evaluator>> EvaluatorsUpdateAsResponseAsync(
            string evaluatorId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEvaluatorsUpdateArguments(
            ...
            var __authorizations = global::Langfuse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EvaluatorsUpdateSecurityRequirements,
                operationName: "EvaluatorsUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEvaluatorsUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Langfuse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EvaluatorsUpdate",
                                methodName: "EvaluatorsUpdateAsync",
                                pathTemplate: "$\"/api/public/v2/evaluators/{evaluatorId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEvaluatorsUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 412)
                            {
                                ...
                                global::Langfuse.PublicApiError? __value_412 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_412 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_412 = global::Langfuse.PublicApiError.FromJson(__content_412, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_412 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEvaluatorsUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Langfuse.Evaluator.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Langfuse.AutoSDKHttpResponse<global::Langfuse.Evaluator>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Langfuse.Evaluator.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.Evaluator> EvaluatorsUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Langfuse.UpdateEvaluatorRequest
            {
            };

            return await EvaluatorsUpdateAsync(
                evaluatorId: evaluatorId,
                request: __request,
                requestOptions: requestOptions,
