...
namespace Langfuse
{
    ...
    public sealed partial class UnstableCreateLlmAsJudgeEvaluationRuleRequest
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Langfuse.UnstableLlmAsJudgeEvaluationRuleEvaluatorReference Evaluator { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnstableCreateLlmAsJudgeEvaluationRuleRequest" /> class.
        /// </summary>
        /// <param name="name">
        /// Human-readable deployment name.
        /// </param>
...
#endif
        public UnstableCreateLlmAsJudgeEvaluationRuleRequest(
            string name,
