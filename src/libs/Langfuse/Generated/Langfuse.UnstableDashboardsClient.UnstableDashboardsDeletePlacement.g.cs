...
namespace Langfuse
{
    public partial class UnstableDashboardsClient
    {
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement s_UnstableDashboardsDeletePlacementSecurityRequirement0 =
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement[] s_UnstableDashboardsDeletePlacementSecurityRequirements =
            new global::Langfuse.EndPointSecurityRequirement[]
            {                s_UnstableDashboardsDeletePlacementSecurityRequirement0,
            };
        partial void PrepareUnstableDashboardsDeletePlacementArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string dashboardId,
            ref string placementId);
        partial void PrepareUnstableDashboardsDeletePlacementRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string dashboardId,
            string placementId);
        partial void ProcessUnstableDashboardsDeletePlacementResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUnstableDashboardsDeletePlacementResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.UnstableDeleteDashboardPlacementResponse> UnstableDashboardsDeletePlacementAsync(
            string dashboardId,
            string placementId,
            global::Langfuse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await UnstableDashboardsDeletePlacementAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Langfuse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Langfuse.AutoSDKHttpResponse<global::Langfuse.UnstableDeleteDashboardPlacementResponse>> UnstableDashboardsDeletePlacementAsResponseAsync(
            string dashboardId,
            string placementId,
            global::Langfuse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUnstableDashboardsDeletePlacementArguments(
            ...
            var __authorizations = global::Langfuse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnstableDashboardsDeletePlacementSecurityRequirements,
                operationName: "UnstableDashboardsDeletePlacementAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUnstableDashboardsDeletePlacementRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Langfuse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UnstableDashboardsDeletePlacement",
                                methodName: "UnstableDashboardsDeletePlacementAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUnstableDashboardsDeletePlacementResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnstableDashboardsDeletePlacementResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Langfuse.UnstableDeleteDashboardPlacementResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Langfuse.AutoSDKHttpResponse<global::Langfuse.UnstableDeleteDashboardPlacementResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Langfuse.UnstableDeleteDashboardPlacementResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
