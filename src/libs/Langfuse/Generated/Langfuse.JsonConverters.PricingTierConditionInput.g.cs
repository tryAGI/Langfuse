...
{
    /// <inheritdoc />
    public class PricingTierConditionInputJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Langfuse.PricingTierConditionInput>
    {
        /// <inheritdoc />
        public override global::Langfuse.PricingTierConditionInput Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Langfuse.PricingTierUsageConditionInput? pricingTierUsageConditionInput = default;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        pricingTierUsageConditionInput = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            if (pricingTierUsageConditionInput == null && pricingTierAttributeCondition == null)
            {
                try
                {
            ...
            var __value = new global::Langfuse.PricingTierConditionInput(
        ...
        public override void Write(
            ...
            global::Langfuse.PricingTierConditionInput value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsPricingTierUsageConditionInput)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Langfuse.PricingTierUsageConditionInput), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Langfuse.PricingTierUsageConditionInput?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Langfuse.PricingTierUsageConditionInput).Name}");
