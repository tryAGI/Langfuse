...
namespace Langfuse
{
    public partial class UnstableSkillsClient
    {
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement s_UnstableSkillsListSecurityRequirement0 =
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement[] s_UnstableSkillsListSecurityRequirements =
            new global::Langfuse.EndPointSecurityRequirement[]
            {                s_UnstableSkillsListSecurityRequirement0,
            };
        partial void PrepareUnstableSkillsListArguments(
        ...
        partial void PrepareUnstableSkillsListRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessUnstableSkillsListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUnstableSkillsListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.UnstableSkillMetaListResponse> UnstableSkillsListAsync(
            string? name = default,
        ...
        {
            var __response = await UnstableSkillsListAsResponseAsync(
                name: name,
                search: search,
                tag: tag,
                page: page,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Langfuse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Langfuse.AutoSDKHttpResponse<global::Langfuse.UnstableSkillMetaListResponse>> UnstableSkillsListAsResponseAsync(
            string? name = default,
            string? search = default,
            string? tag = default,
            int? page = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUnstableSkillsListArguments(
            ...
            var __authorizations = global::Langfuse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnstableSkillsListSecurityRequirements,
                operationName: "UnstableSkillsListAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUnstableSkillsListRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Langfuse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UnstableSkillsList",
                                methodName: "UnstableSkillsListAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUnstableSkillsListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnstableSkillsListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Langfuse.UnstableSkillMetaListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Langfuse.AutoSDKHttpResponse<global::Langfuse.UnstableSkillMetaListResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Langfuse.UnstableSkillMetaListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
