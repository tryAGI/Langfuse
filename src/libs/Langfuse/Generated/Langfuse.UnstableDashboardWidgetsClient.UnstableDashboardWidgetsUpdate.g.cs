...
namespace Langfuse
{
    public partial class UnstableDashboardWidgetsClient
    {
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement s_UnstableDashboardWidgetsUpdateSecurityRequirement0 =
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement[] s_UnstableDashboardWidgetsUpdateSecurityRequirements =
            new global::Langfuse.EndPointSecurityRequirement[]
            {                s_UnstableDashboardWidgetsUpdateSecurityRequirement0,
            };
        partial void PrepareUnstableDashboardWidgetsUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string widgetId,
            global::Langfuse.UnstableUpdateDashboardWidgetRequest request);
        partial void PrepareUnstableDashboardWidgetsUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string widgetId,
            global::Langfuse.UnstableUpdateDashboardWidgetRequest request);
        partial void ProcessUnstableDashboardWidgetsUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUnstableDashboardWidgetsUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.UnstableDashboardWidget> UnstableDashboardWidgetsUpdateAsync(
            string widgetId,
        ...
        {
            var __response = await UnstableDashboardWidgetsUpdateAsResponseAsync(
                widgetId: widgetId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Langfuse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Langfuse.AutoSDKHttpResponse<global::Langfuse.UnstableDashboardWidget>> UnstableDashboardWidgetsUpdateAsResponseAsync(
            string widgetId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUnstableDashboardWidgetsUpdateArguments(
            ...
            var __authorizations = global::Langfuse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnstableDashboardWidgetsUpdateSecurityRequirements,
                operationName: "UnstableDashboardWidgetsUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUnstableDashboardWidgetsUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Langfuse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UnstableDashboardWidgetsUpdate",
                                methodName: "UnstableDashboardWidgetsUpdateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUnstableDashboardWidgetsUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnstableDashboardWidgetsUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.UnstableDashboardWidget> UnstableDashboardWidgetsUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Langfuse.UnstableUpdateDashboardWidgetRequest
            {
                Name = name,
            ...
            return await UnstableDashboardWidgetsUpdateAsync(
                widgetId: widgetId,
                request: __request,
                requestOptions: requestOptions,
