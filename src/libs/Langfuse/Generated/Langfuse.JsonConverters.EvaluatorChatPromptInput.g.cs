...
{
    /// <inheritdoc />
    public class EvaluatorChatPromptInputJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Langfuse.EvaluatorChatPromptInput>
    {
        /// <inheritdoc />
        public override global::Langfuse.EvaluatorChatPromptInput Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::System.Collections.Generic.IList<global::Langfuse.EvaluatorChatMessage>), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::System.Collections.Generic.IList<global::Langfuse.EvaluatorChatMessage>? evaluatorChatPrompt = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        evaluatorChatPrompt = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (@string == null && evaluatorChatPrompt == null)
            {
                try
                {
            ...
            var __value = new global::Langfuse.EvaluatorChatPromptInput(
                @string,
        ...
        public override void Write(
            ...
            global::Langfuse.EvaluatorChatPromptInput value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
