...
namespace Langfuse
{
    public partial class UnstableSkillsClient
    {
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement s_UnstableSkillsSetLabelsSecurityRequirement0 =
        ...
        private static readonly global::Langfuse.EndPointSecurityRequirement[] s_UnstableSkillsSetLabelsSecurityRequirements =
            new global::Langfuse.EndPointSecurityRequirement[]
            {                s_UnstableSkillsSetLabelsSecurityRequirement0,
            };
        partial void PrepareUnstableSkillsSetLabelsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string skillName,
            ref int skillVersion,
            global::Langfuse.UnstableUpdateSkillLabelsRequest request);
        partial void PrepareUnstableSkillsSetLabelsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string skillName,
            int skillVersion,
            global::Langfuse.UnstableUpdateSkillLabelsRequest request);
        partial void ProcessUnstableSkillsSetLabelsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUnstableSkillsSetLabelsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.UnstableSkillVersion> UnstableSkillsSetLabelsAsync(
            string skillName,
            int skillVersion,
        ...
        {
            var __response = await UnstableSkillsSetLabelsAsResponseAsync(
                skillName: skillName,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Langfuse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Langfuse.AutoSDKHttpResponse<global::Langfuse.UnstableSkillVersion>> UnstableSkillsSetLabelsAsResponseAsync(
            string skillName,
            int skillVersion,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUnstableSkillsSetLabelsArguments(
            ...
            var __authorizations = global::Langfuse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnstableSkillsSetLabelsSecurityRequirements,
                operationName: "UnstableSkillsSetLabelsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUnstableSkillsSetLabelsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Langfuse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UnstableSkillsSetLabels",
                                methodName: "UnstableSkillsSetLabelsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUnstableSkillsSetLabelsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Langfuse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnstableSkillsSetLabelsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Langfuse.UnstableSkillVersion.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Langfuse.AutoSDKHttpResponse<global::Langfuse.UnstableSkillVersion>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Langfuse.UnstableSkillVersion.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Langfuse.UnstableSkillVersion> UnstableSkillsSetLabelsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Langfuse.UnstableUpdateSkillLabelsRequest
            {
                Labels = labels,
            };

            return await UnstableSkillsSetLabelsAsync(
                skillName: skillName,
                skillVersion: skillVersion,
                request: __request,
                requestOptions: requestOptions,
